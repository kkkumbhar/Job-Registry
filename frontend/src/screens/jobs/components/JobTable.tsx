...
import { firstColumnSticky, lastColumnSticky, thinDarkScrollbar } from "../../../tableStyles/TableStyles";
...
const JobTable: React.FC<JobsTableProps> = ({
    ...
    const handleRowClick = (e: React.MouseEvent, job: Job) => {
        ...
        //    // navigate(`/monitoring/jobs/protection/${job.id}`);
        // } else {
        //    // navigate(`/monitoring/jobs/${job.id}`);
        // }
        // onShowNotification?.(`Viewing job: ${job.name}`, "success");
    };
                            ...
                            jobs.map((row) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell sx={{ ...commonCellStyles, color: "#222" }}>{row.name}</TableCell>
                                        ...
                                        <TableCell sx={{ ...commonCellStyles, color: "#222" }}>
                                            <Box
                                                sx={{
                                                    ...
                                                    padding: "6px 16px",
                                                    borderRadius: "20px",
                                                    backgroundColor: row.source === "fleet" ? "#e3f2fd" : "#fff3e0",
